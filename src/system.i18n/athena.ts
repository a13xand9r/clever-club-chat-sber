export const athena = {
    ...
    Помощь: 'Чтобы узнать ответ, скажите «Ответ» или «Сдаюсь», чтобы услышать следующий вопрос, скажите «Следующий». Чтобы ответить, не обязательно говорить фразу точь-в-точь, можно сказать просто похоже на верный ответ',
    'Верно': [
        'Верно! {answer}\n{comment}',
        'Правильно! {answer}\n{comment}',
        'Все верно! {answer}\n{comment}',
